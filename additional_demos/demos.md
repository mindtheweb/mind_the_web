...
## 6.3.X Exfiltrating Overleaf Project Names (P2, Extraction of Sensitive Personal Information, Browser Use)
...
## 6.3.X Extracting Browser-Autofilled Credentials (P3, Credential Hijacking, Do Browser)
